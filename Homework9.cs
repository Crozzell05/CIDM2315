...
class Program
{
    ...
    public static void TotalCredits(Customer[] customer_list)
    {
        ...
        Console.WriteLine("Q1: Total credit of all customers = " + totalCredit);
    }
    ...
    public static void AmarilloAverageAge(Customer[] customer_list)
    {
        ...
        if (count > 0)
        {
            ...
            Console.WriteLine("Q2: Average age of customers living in Amarillo = " + averageAge);
        }
        else
        {
    ...
    {
        Console.WriteLine("Q3: Customers who live in Canyon and are older than 30:");
